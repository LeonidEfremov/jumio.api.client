...
namespace Jumio.Api.Netverify
{
    ...
    public partial interface IClient
    {
        ...
        /// <summary>
        /// Offers a Restful ID verification API without Jumio-hosted user interface.
        /// </summary>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        ...
        /// <summary>
        /// Receive the status of a scan by specifying the Jumio scan reference as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Removes sensitive data and image(s) of a scan by specifying the Jumio scan reference as a path parameter.
        /// </summary>
        /// <param name="scanReference">Reference to a specific scan for retrieving or deleting</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<EmptyDocument> DeleteScanAsync(System.Guid scanReference);
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<EmptyDocument> DeleteScanAsync(System.Guid scanReference, System.Threading.CancellationToken cancellationToken);

        /// <summary>
        /// Receive document, transaction and verification details of a scan by specifying the Jumio scan reference as a path parameter.
        /// </summary>
        /// <param name="scanReference">Reference to a specific scan for retrieving or deleting</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        ...
        /// <summary>
        /// Receive document related data of a scan by specifying the Jumio scan reference as a path parameter.
        /// </summary>
        /// <param name="scanReference">Reference to a specific scan for retrieving or deleting</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        ...
        /// <summary>
        /// Receive transaction related data of a scan by specifying the Jumio scan reference as a path parameter.
        /// </summary>
        /// <param name="scanReference">Reference to a specific scan for retrieving or deleting</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        ...
        /// <summary>
        /// Receive available images of a scan by specifying the Jumio scan reference as a path parameter.
        /// </summary>
        /// <param name="scanReference">Reference to a specific scan for retrieving or deleting</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<EmptyDocument> DeleteScan2Async(System.Guid scanReference);
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<EmptyDocument> DeleteScan2Async(System.Guid scanReference, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class Client : ClientBase, IClient
    {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ConnectionSettings> InitiateAsync(UserSettings body)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ConnectionSettings> InitiateAsync(UserSettings body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ConnectionSettings>(response_, headers_, cancellationToken).ConfigureAwait(false);
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ScanReference> SubmitAsync(UploadScan body)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ScanReference> SubmitAsync(UploadScan body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ScanReference>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ScanStatus> GetScanStatusAsync(System.Guid scanReference)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ScanStatus> GetScanStatusAsync(System.Guid scanReference, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ScanStatus>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<EmptyDocument> DeleteScanAsync(System.Guid scanReference)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<EmptyDocument> DeleteScanAsync(System.Guid scanReference, System.Threading.CancellationToken cancellationToken)
        {
            if (scanReference == null)
                throw new System.ArgumentNullException("scanReference");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<EmptyDocument>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ScanDetails> GetScanDataAsync(System.Guid scanReference)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ScanDetails> GetScanDataAsync(System.Guid scanReference, System.Threading.CancellationToken cancellationToken)
        {
            if (scanReference == null)
                throw new System.ArgumentNullException("scanReference");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ScanDetails>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ScanDocumentData> GetScanDocumentDataOnlyAsync(System.Guid scanReference)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ScanDocumentData> GetScanDocumentDataOnlyAsync(System.Guid scanReference, System.Threading.CancellationToken cancellationToken)
        {
            if (scanReference == null)
                throw new System.ArgumentNullException("scanReference");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ScanDocumentData>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ScanTransactionData> GetScanTransactionDataOnlyAsync(System.Guid scanReference)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ScanTransactionData> GetScanTransactionDataOnlyAsync(System.Guid scanReference, System.Threading.CancellationToken cancellationToken)
        {
            if (scanReference == null)
                throw new System.ArgumentNullException("scanReference");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ScanTransactionData>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ScanVerificationData> GetScanVerificationDataOnlyAsync(System.Guid scanReference)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ScanVerificationData> GetScanVerificationDataOnlyAsync(System.Guid scanReference, System.Threading.CancellationToken cancellationToken)
        {
            if (scanReference == null)
                throw new System.ArgumentNullException("scanReference");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ScanVerificationData>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<Images> GetScanImagesAsync(System.Guid scanReference)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<Images> GetScanImagesAsync(System.Guid scanReference, System.Threading.CancellationToken cancellationToken)
        {
            if (scanReference == null)
                throw new System.ArgumentNullException("scanReference");
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<FileResponse> GetScanImageAsync(System.Guid scanReference, Classifier classifier, Maskhint? maskhint)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<FileResponse> GetScanImageAsync(System.Guid scanReference, Classifier classifier, Maskhint? maskhint, System.Threading.CancellationToken cancellationToken)
        {
            if (scanReference == null)
                throw new System.ArgumentNullException("scanReference");
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<DocumentStatus> GetDocStatusAsync(System.Guid scanReference)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<DocumentStatus> GetDocStatusAsync(System.Guid scanReference, System.Threading.CancellationToken cancellationToken)
        {
            if (scanReference == null)
                throw new System.ArgumentNullException("scanReference");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<DocumentStatus>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<EmptyDocument> DeleteScan2Async(System.Guid scanReference)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<EmptyDocument> DeleteScan2Async(System.Guid scanReference, System.Threading.CancellationToken cancellationToken)
        {
            if (scanReference == null)
                throw new System.ArgumentNullException("scanReference");
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<DocumentDetails> GetDocumentDataAsync(System.Guid scanReference)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<DocumentDetails> GetDocumentDataAsync(System.Guid scanReference, System.Threading.CancellationToken cancellationToken)
        {
            if (scanReference == null)
                throw new System.ArgumentNullException("scanReference");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<DocumentDetails>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<DocDocumentData> GetDocumentsDocumentDataOnlyAsync(System.Guid scanReference)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<DocDocumentData> GetDocumentsDocumentDataOnlyAsync(System.Guid scanReference, System.Threading.CancellationToken cancellationToken)
        {
            if (scanReference == null)
                throw new System.ArgumentNullException("scanReference");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<DocDocumentData>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<DocTransactionData> GetDocumentsTransactionDataOnlyAsync(System.Guid scanReference)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<DocTransactionData> GetDocumentsTransactionDataOnlyAsync(System.Guid scanReference, System.Threading.CancellationToken cancellationToken)
        {
            if (scanReference == null)
                throw new System.ArgumentNullException("scanReference");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<DocTransactionData>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<Images> GetDocImagesAsync(System.Guid scanReference)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<Images> GetDocImagesAsync(System.Guid scanReference, System.Threading.CancellationToken cancellationToken)
        {
            if (scanReference == null)
                throw new System.ArgumentNullException("scanReference");
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<FileResponse> GetDocImageAsync(System.Guid scanReference, Classifier classifier, Maskhint? maskhint)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<FileResponse> GetDocImageAsync(System.Guid scanReference, Classifier classifier, Maskhint? maskhint, System.Threading.CancellationToken cancellationToken)
        {
            if (scanReference == null)
                throw new System.ArgumentNullException("scanReference");
    ...
    public partial class EmptyDocument
    {
    ...
    /// <summary>
    /// For ID verification: index is 1, required fields are country and type; for identify verification index is 2 and required field is phrase 
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.15.6.0 (NJsonSchema v10.6.7.0 (Newtonsoft.Json v13.0.0.0))")]
    ...
    /// <summary>
    /// JSON object containing the information about connection.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.15.6.0 (NJsonSchema v10.6.7.0 (Newtonsoft.Json v13.0.0.0))")]
    ...
    public partial class UploadScan
    {
        ...
        /// <summary>
        /// Mandatory if Face match enabled. Base64 encoded image of face
        /// </summary>
        [Newtonsoft.Json.JsonProperty("faceImage", Required = Newtonsoft.Json.Required.Always)]
        public string FaceImage { get; set; }

        /// <summary>
        /// Possible countries: https://en.wikipedia.org/wiki/ISO_3166-1_alpha-3
        /// </summary>
        ...
        /// <summary>
        /// Base64 encoded image of ID back side
        /// </summary>
        ...
        /// <summary>
        /// Defines fields which will be extracted during the ID verification. If a field is not listed in this parameter, it will not be processed for this transaction, regardless of customer portal settings. Note: Face match and Address extraction will not be processed unless enabled for your account. If you want to enable them, please contact your Customer Success Manager, or reach out to Jumio Support.
        /// </summary>
        ...
        /// <summary>
        /// Identification of the customer must not contain sensitive data like PII (Personally Identificable Information) or account login
        /// </summary>
        ...
        /// <summary>
        /// Possible values: onFinish (default): Callback is only sent after the whole verification; onAllSteps: Additional callback is sent when the images are received
        /// </summary>
    ...
    public partial class USAddressFormat
    {
        ...
        /// <summary>
        /// Unit designator abbreviation. Examples: US, Canada, Australia 
        /// </summary>
    ...
    public partial class CallbackTransaction
    {
        ...
        /// <summary>
        /// IP address of the client if provided for the Document Verification API
        /// </summary>
        [Newtonsoft.Json.JsonProperty("clientIp", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    {
        /// <summary>
        /// Full name if readable
        /// </summary>
        [Newtonsoft.Json.JsonProperty("name", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Name { get; set; }

        /// <summary>
        /// Bank account number of the customer from a bank statement
        /// </summary>
        ...
        /// <summary>
        /// Personal account number of credit card
        /// </summary>
        ...
        /// <summary>
        /// Issue date in the format YYYY-MM-DD
        /// </summary>
        [Newtonsoft.Json.JsonProperty("issueDate", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [Newtonsoft.Json.JsonConverter(typeof(DateFormatConverter))]
        public System.DateTimeOffset? IssueDate { get; set; }
