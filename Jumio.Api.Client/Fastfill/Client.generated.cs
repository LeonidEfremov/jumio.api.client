...
namespace Jumio.Api.Fastfill
{
    ...
    {
        /// <summary>Submit front and/or back side image(s) of the user's document and you will immediately receive the ID information as a JSON response.</summary>
        /// <returns>OK</returns>
    ...
    public partial class Client : ClientBase, IClient
    {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<DocumentData> SubmitAsync(Metadata metadata, FileParameter frontsideImage, FileParameter backsideImage)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<DocumentData> SubmitAsync(Metadata metadata, FileParameter frontsideImage, FileParameter backsideImage, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<DocumentData>(response_, headers_).ConfigureAwait(false);
